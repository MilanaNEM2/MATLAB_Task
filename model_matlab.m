...
weeks = {
    struct('start', datetime(2023,1,1),  'end', datetime(2023,1,7,23,0,0),  'weatherFile', 'Tallinn 2023-01-01 to 2023-01-31.csv');
    struct('start', datetime(2023,2,12), 'end', datetime(2023,2,18,23,0,0), 'weatherFile', 'Tallinn 2023-02-01 to 2023-02-28.csv');
    struct('start', datetime(2023,3,26), 'end', datetime(2023,4,1,23,0,0),  'weatherFile', 'Tallinn 2023-03-01 to 2023-04-30.csv');
    struct('start', datetime(2023,5,7),  'end', datetime(2023,5,13,23,0,0), 'weatherFile', 'Tallinn 2023-05-01 to 2023-05-31.csv');
    struct('start', datetime(2023,6,18), 'end', datetime(2023,6,24,23,0,0), 'weatherFile', 'Tallinn 2023-06-01 to 2023-06-30.csv');
    struct('start', datetime(2023,7,30), 'end', datetime(2023,8,5,23,0,0),  'weatherFile', 'Tallinn 2023-07-01 to 2023-08-31.csv');
    struct('start', datetime(2023,9,10), 'end', datetime(2023,9,16,23,0,0), 'weatherFile', 'Tallinn 2023-09-01 to 2023-09-30.csv');
    struct('start', datetime(2023,10,22),'end', datetime(2023,10,28,23,0,0),'weatherFile', 'Tallinn 2023-10-01 to 2023-10-31.csv');
    struct('start', datetime(2023,12,3), 'end', datetime(2023,12,9,23,0,0), 'weatherFile', 'Tallinn 2023-12-01 to 2023-12-31.csv');
};
